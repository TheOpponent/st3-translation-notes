...
def main():
    ...
    for filename in [i for i in os.listdir(source_path) if i.lower().endswith(('.lc1'))]:
        try:
            with open(os.path.join(source_path,filename),"rb") as input_data:
                ...
                for i in range(0,image_num):
                    ...
                    value1 = struct.unpack("<I",input_data.read(4))[0]
                ...
                for i in enumerate(images):
                    output_filename = os.path.join(translate_path, filename + f"_{i[0]}" ".png")
                    ...
                    if not os.path.exists(os.path.join(backups_path, filename + f"_{i[0]}" ".png")):
                        copyfile(output_filename,os.path.join(backups_path, filename + f"_{i[0]}" ".png"))
