...
def read_binary(file,offset=0):
    ...
    while True:
        ...
        # Byte 0xfc is a control code that reads the next two bytes and forms a voiced kana character by writing the on pixels of the second byte over the first.
        elif i == b'\xfc':
            i = file.read(2) 
            string += table.get(i,"")
