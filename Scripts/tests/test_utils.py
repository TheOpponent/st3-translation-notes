...
def test_linebreak():
    ...
    assert utils.linebreak(test_string1) == (r"Lorem ipsum dolor sit amet,\consectetur adipiscing elit, sed do\eiusmod labore et dolor magna aliqua.",3,0)
    ...
    assert utils.linebreak(test_string2) == (r"Lorem ipsum\dolor sit amet, consectetur\adipiscing elit, sed do eiusmod\labore et dolor magna aliqua.",4,1)