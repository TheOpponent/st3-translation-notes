...
def convert_screen_data(input_file):
    ...
    with Image.open(input_file) as input_file:
        ...
        try:
            ...
            print("Input PNG file must be 8-bit, no transparency, and have a height of 32 pixels and width a multiple of 48 pixels.")
            return

        if len(sys.argv) >= 3:
            with open(sys.argv[2],"wb") as output_file:
                output_file.write(output)
                print(f"Paste the contents of {sys.argv[2]} into a VMU screen data file starting at the tile(s) to replace.")
